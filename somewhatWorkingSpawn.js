...
let inputState = false
  ...
  async function processInputData(inputData) {
    if (typeof inputData === 'function' && inputData != null) {
       let result;
...
!async function (){
let dd = await terminal.input("hello msn")
console.log(dd + "cool")
  
 dd = await terminal.input("hello msn")
console.log(dd + "cool22") 
